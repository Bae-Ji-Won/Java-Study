package Date10_21.Algorithm.Factory;
...
class JdbcUserDaoTest {
    ...
    Date10_20.dao.Factory.UserDao userDao;
    User user1;
    User user2;
    User user3;
    ...
    void setUp(){       // 각각의 테스트 시작전 필수로 동작하는 부분
        userDao = context.getBean("awsUserDao", Date10_20.dao.Factory.UserDao.class);
    ...
    void count() throws SQLException, ClassNotFoundException {
        ...
        Date10_20.dao.Factory.UserDao userDao = context.getBean("awsUserDao", UserDao.class);
        //.deleteAll() 오류 검증
        userDao.deleteAll();
