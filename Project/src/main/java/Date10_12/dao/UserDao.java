package Date10_12.dao;

import Date10_12.domain.User;
...
public class UserDao {
    ...
    private static String dbHost = env.get("DB_HOST");         // DB 호스트 번호(AWS 주소) 가져옴
    private static String dbUser = env.get("DB_USER");             // DB 호스트 이름  가져옴
    private static String dbPassword = env.get("DB_PASSWORD");     // DB 비밀번호  가져옴
    ...
    public void add() throws ClassNotFoundException {
        ...
        try{
            ...
            ps.setString(1,"5");        // mysql 테이블로 값 insert
